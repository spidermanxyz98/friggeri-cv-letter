...
\usepackage[french, english]{babel} % makes FRENCH content
%\usepackage[english, french]{babel} % makes ENGLISH content

% this is the macro to define phrases in two languages:
\newcommand{\trad}[2]{\ifnum\pdfstrcmp{\languagename}{english}=0 {#2}\else{#1}\fi}
